...
--THE ROLE DBA => IN ORDER TO CREARE THE TABLES WHIT THIS USER
GRANT CREATE SESSION, DBA TO legittrip;
ALTER USER legittrip IDENTIFIED BY Admin1234 ACCOUNT UNLOCK;  
